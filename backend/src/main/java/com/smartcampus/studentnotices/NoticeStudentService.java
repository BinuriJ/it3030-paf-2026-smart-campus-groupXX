...
import com.smartcampus.notices.AppNotice;
import com.smartcampus.notices.NoticeMainRepository;
...
@Service
public class NoticeStudentService {

    private final NoticeMainRepository noticeRepository;
    private final StudentNoticeStatusRepository studentNoticeStatusRepository;

    public NoticeStudentService(
        NoticeMainRepository noticeRepository,
    ...
    public List<StudentNoticeView> getNoticesForStudent(String studentId) {
        ...
        List<AppNotice> notices = noticeRepository.findAllByOrderByCreatedAtDesc();
    ...
    public StudentNoticeView markNoticeAsSeen(MarkNoticeSeenRequest request) {
        ...
        AppNotice notice = noticeRepository.findById(request.getNoticeId())
