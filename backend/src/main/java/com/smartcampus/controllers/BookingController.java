...
public class BookingController {
    ...
    // CREATE BOOKING (USER)
    @PostMapping
    public ResponseEntity<?> create(@Valid @RequestBody BookingModel b) {
        ...
        try {
            ...
            BookingModel created = service.save(b);
    ...
    public ResponseEntity<?> update(
        ...
        try {
            ...
            BookingModel updated = service.update(id, b, userName);
