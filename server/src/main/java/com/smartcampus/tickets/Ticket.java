...
function Tickets() {
  ...
  const [form, setForm] = useState({
    ...
    priority: 'LOW', location: '', contactDetails: ''
  })
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setFiles([])
      setErrors({})
      setForm({ title: '', category: '', description: '', priority: 'LOW', location: '', contactDetails: '' })
      loadTickets()
    } catch {
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6 mb-8 shadow-sm">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          {/* Priority */}
          <div>
            <select className="border border-gray-300 rounded p-2 w-full text-sm focus:outline-none focus:ring-2 focus:ring-blue-200"
          ...
          {/* Description */}
          <div className="col-span-2">
            <textarea className={inputClass('description')}
