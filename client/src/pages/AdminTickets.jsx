          ...
          <div className="border border-gray-200 rounded-lg p-5 shadow-sm">
            ...
            <div className="mb-4">
              <textarea className="border border-gray-300 rounded p-2 w-full text-sm mb-2 focus:outline-none focus:ring-2 focus:ring-blue-200"
                placeholder="Resolution notes" rows={2} value={resolutionNotes}
            ...
            {stats && (
              <div className="bg-gray-50 border border-gray-200 rounded p-3 mb-4 text-sm">
                ...
                <p className="text-gray-600">First Response: {stats.timeToFirstResponseMinutes != null ? `${stats.timeToFirstResponseMinutes} mins` : 'Not yet'}</p>
                <p className="text-gray-600">Resolution Time: {stats.timeToResolutionMinutes != null ? `${stats.timeToResolutionMinutes} mins` : 'Not yet'}</p>
              </div>
            )}
